            ...
            {tabs.map((tab) => (
              <button
                ...
                className={`py-4 px-1 border-b-2 font-medium text-sm flex items-center gap-2 transition-colors ${
                  activeTab === tab.id ? 'border-sky-400 text-sky-400' : 'border-transparent hover:border-gray-300'
                }`}
                style={{ color: activeTab === tab.id ? 'var(--color-sky)' : 'var(--color-text-secondary)' }}
              >
                {tab.label}
              </button>
            ))}
              ...
              <div className="surface-glass rounded-lg p-6">
                ...
                <div className="grid gap-4">
                  <div>
                    ...
                    <p className="text-lg" style={{ color: 'var(--color-text-primary)' }}>{user.full_name}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium" style={{ color: 'var(--color-text-secondary)' }}>
                      Email Address
          ...
          {activeTab === 'settings' && (
            <div className="grid gap-6">
              ...
              <div className="surface-glass rounded-lg p-6">
                ...
                <button onClick={handleLogout} className="btn text-red-400 border-red-500/30 hover:bg-red-500/20">
                  Sign Out
                </button>
              </div>
            </div>
